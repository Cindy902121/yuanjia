...
> 狀態：基礎矩陣已於 2026-08-10 確認；Admin 本週 P1 於 2026-08-25 定稿，C 後台商品管理能力已整合。

## 登入方式

| 身分 | 登入資料 | 登入成功後 |
| --- | --- | --- |
| B2C 會員 | Email + 密碼、Google OAuth | 留在 B2C 流程 |
| B2B 公司使用者 | 外部系統提供的客戶代碼（Z/E/W＋6 碼數字）+ 公司共用密碼 | `/business/catalog` |
