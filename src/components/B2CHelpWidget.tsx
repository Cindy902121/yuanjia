 ...
 *
 * 2026-09-11（同日，使用者回饋章魚本體顏色太暗、常常看不到）：章魚本體
 * （五條觸手＋頭部橢圓）從 ink `#0B1620` 改成 coral `#FF5A36`——使用者
 * 明確要求「我們用來強調用的珊瑚色」，站上這個色階本來就是 hover／
 * background 強調色（見上面 2026-09-11 第一段註解），這裡拿來當本體主色
 * 剛好對應這個既有語意。頭部原本的深色陰影橢圓（`#17364C`，模擬立體感）
 * 跟著從深藍改成 `#C2401D`（既有的深珊瑚色 token，靜態文字對比色），維持
 * 同一色系的深淺層次，不是留著一塊跟新主色不協調的深藍色塊。眼白／瞳孔
 * ／對話泡泡的顏色都沒有動——白眼珠＋黑瞳孔在珊瑚色本體上一樣有足夠對比，
 * 不需要跟著換色。
 */
      ...
      >
        ...
        <svg viewBox="0 0 64 64" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
          <g className="octo-body">
            ...
            <ellipse cx="32" cy="26.5" rx="19.5" ry="17.5" fill="#FF5A36" />
            <ellipse cx="27" cy="17.5" rx="5.5" ry="3.2" fill="#C2401D" opacity="0.4" />
