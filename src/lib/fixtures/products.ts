...
export const products: ProductDetailData[] = [
  {
    ...
    tags: [
      { slug: "salmon", name: "鮭魚" },
      { slug: "pan-fry", name: "煎／烤" },
      { slug: "air-fry", name: "氣炸" },
      { slug: "boneless", name: "少刺／無刺" },
      { slug: "high-protein", name: "高蛋白" },
      { slug: "original", name: "原味" },
    ],
    brand: "元家",
  ...
  },
  {
    ...
    tags: [
      { slug: "salmon", name: "鮭魚" },
      { slug: "pan-fry", name: "煎／烤" },
      { slug: "easy-to-cook", name: "方便料理" },
      { slug: "seasoned", name: "調味" },
    ],
    brand: "元家",
  ...
  },
  {
    ...
    coverImage: null,
    tags: [
      { slug: "scallop", name: "干貝" },
      { slug: "raw", name: "生食" },
      { slug: "right-portion", name: "份量剛好" },
      { slug: "original", name: "原味" },
    ],
    brand: "元家×北光 聯名",
