  ...
  return (
    ...
    >
      <section className="w-full max-w-md rounded-2xl border border-[#D9E1E5] bg-white p-7 shadow-[0_12px_32px_rgba(23,36,42,0.08)] sm:p-9">
        ...
        <h1 className="mt-3 text-[32px] font-bold tracking-tight text-[#17242A]">建立新帳號</h1>
        <p className="mt-3 text-base leading-7 text-[#536168]">建立 B2C 會員帳號，之後可使用 Email 與密碼登入。</p>
        <SignupForm />
      </section>
    </main>
  );
