...
export default async function RfqPage() {
  ...
  return <div className="min-h-screen bg-white text-[#17242A]"><BusinessHeader companyName={access.companyName} /><main className="mx-auto max-w-6xl px-5 py-8 lg:px-8"><BusinessBreadcrumb current="詢價紀錄" /><div className="mt-6"><p className="text-xs font-bold tracking-[.16em] text-[#005DAA]">INQUIRY HISTORY</p><h1 className="mt-2 text-3xl font-bold">過往詢價紀錄</h1><p className="mt-2 text-sm text-[#536168]">查看已送出的詢價明細與目前處理狀態。</p></div><RfqHistoryClient /></main></div>;
}
