      ...
      <div className="mx-auto flex min-h-[72px] max-w-[1440px] flex-wrap items-center justify-between gap-x-5 gap-y-3 px-5 py-3 lg:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative">
            ...
            {profileOpen ? <div className="absolute right-0 top-full z-50 mt-2 w-44 rounded-xl border border-[#D9E1E5] bg-white p-2 shadow-xl" role="menu"><Link className="block w-full rounded-lg px-3 py-2 text-left text-sm font-semibold text-[#536168] hover:bg-[#F1F5F7] hover:text-[#17242A]" href="/business/password" role="menuitem">修改密碼</Link><button className="w-full rounded-lg px-3 py-2 text-left text-sm font-semibold text-[#536168] hover:bg-[#F1F5F7] hover:text-[#17242A]" disabled={isSigningOut} onClick={signOut} role="menuitem" type="button">{isSigningOut ? "登出中…" : "登出"}</button></div> : null}
          </div>
        </div>
      </div>
