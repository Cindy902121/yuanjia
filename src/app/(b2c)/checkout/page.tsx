...
export default async function CheckoutPage() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-[1200px] flex-1 flex-col gap-6 bg-white px-5 py-16 font-[family-name:var(--ep-font-sans)] text-[#0B1620] sm:px-8 lg:py-20">
      <CheckoutForm />
    </main>
  );
}
